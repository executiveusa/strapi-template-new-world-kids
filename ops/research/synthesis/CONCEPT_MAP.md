...
```mermaid
graph TD
    Emad["<b>Emad Mostaque</b><br/>Intelligent Internet"] --> UBAI["<b>UBAI</b><br/>Universal Basic AI<br/>(every child entitled)"]
    ...
    style MAXX fill:#e8f5e9
    style NWKids fill:#fce4ec
    style Youth fill:#f1f8e9
```
