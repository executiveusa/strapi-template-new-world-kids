...
You keep the donor site, journal, Hermes backend, and remaining legacy Strapi routes healthy, KPIs green, and the
...
- Confirm legacy Strapi-driven catch-all pages still render while migration remains in progress
