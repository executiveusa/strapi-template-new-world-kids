        ...
        <div className="space-y-8 lg:pr-10">
          <div className="flex items-center gap-3">
            ...
            <span className="font-mono text-xs tracking-[0.18em] text-[#C9A84C] uppercase">
              {isSpanish
                ? "Apoya los cuatro pilares"
                : "Support the four pillars"}
            </span>
          </div>

          <div className="space-y-5">
            <h1 className="max-w-4xl font-serif text-4xl leading-tight font-bold tracking-tight text-white sm:text-5xl">
              {isSpanish
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              {
                title: isSpanish
                  ? "Patrocinio fiscal verificado"
                  : "Verified fiscal sponsorship",
              ...
              >
                ...
                <div className="mt-2 text-sm leading-6 text-[#E8DEC7]/58">
                  {item.body}
                </div>
              </div>
            ))}
            ...
            <div className="mb-5 flex items-center justify-between gap-4">
              <div>
                ...
                <div className="mt-2 text-2xl font-semibold text-white">
                  {isSpanish
                    ? "Trabajo real, no humo"
                    : "Real work, not vague promises"}
                </div>
              </div>
              <div className="rounded-sm border border-white/10 px-3 py-2 text-right">
                <div className="text-xs tracking-[0.18em] text-[#E8DEC7]/45 uppercase">
                  {isSpanish ? "Meta actual" : "Current Goal"}
                </div>
                <div className="mt-1 font-serif text-2xl font-bold text-[#C9A84C]">
                  $25,000
                </div>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  value: isSpanish
                    ? "Bosque comestible, semillas y aprendizaje practico"
                    : "Food forest, seeds, and hands-on learning",
                },
                {
                  label: isSpanish ? "Agua" : "Water",
                  value: isSpanish
                    ? "Captacion, almacenamiento y sistemas de riego inteligente"
                    : "Capture, storage, and smart irrigation systems",
                },
                {
                  label: isSpanish ? "Energia" : "Energy",
                  value: isSpanish
                    ? "Conectividad, energia fuera de red y herramientas activas"
                    : "Connectivity, off-grid power, and active tools",
                },
                {
                  label: isSpanish ? "Refugio" : "Shelter",
                  value: isSpanish
                    ? "Bioconstruccion, reparacion y espacio seguro de aprendizaje"
                    : "Natural building, repair, and safe learning space",
                },
              ].map((line) => (
                <div
                  key={line.label}
          ...
          <div className="rounded-sm border border-white/10 bg-[#0E1A13] p-6 shadow-[0_18px_60px_rgba(0,0,0,0.35)] sm:p-8">
            <div className="mb-5 flex items-center justify-between gap-3">
              ...
              <Link
                href="/trust"
                locale={locale}
                className="text-sm text-[#C9A84C] hover:text-[#E3C573]"
              >
              ...
              {(["monthly", "once"] as const).map((option) => {
                ...
                return (
                  <button
                    ...
                    className="h-11 text-sm font-semibold tracking-[0.16em] uppercase transition-colors"
                    style={{
              ...
              {TIERS.map((tier) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-1 text-[11px] tracking-[0.16em] text-[#C9A84C] uppercase">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-6 flex h-13 w-full items-center justify-center rounded-sm bg-[#C9A84C] px-4 text-sm font-semibold tracking-[0.16em] text-[#08100B] uppercase transition-colors hover:bg-[#D7B867]"
            >
              {frequency === "monthly"
                ? isSpanish
