...
const copy = {
  en: { eyebrow: "Support the mission", quote: "If you ever think you're too small to make a difference, try going to sleep with a mosquito in the room.", source: "West African proverb", volunteer: "Volunteer" },
  es: { eyebrow: "Apoya la misión", quote: "Si alguna vez piensas que eres demasiado pequeño para hacer una diferencia, intenta dormir con un mosquito en la habitación.", source: "Proverbio de África Occidental", volunteer: "Participar" },
} as const
    ...
    <section id="support" className="border-t border-[var(--color-border-subtle)] bg-[var(--color-bg)] px-6 py-20 md:px-10">
      <div className="mx-auto max-w-4xl">
        <div className="text-center">
          ...
          <blockquote className="mx-auto mt-4 max-w-3xl font-serif text-3xl leading-tight text-[var(--color-text-primary)] italic md:text-5xl">“{t.quote}”</blockquote>
        ...
        <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <Link href="/work-with-us" locale={locale} className="rounded-full border border-[var(--color-border-subtle)] px-8 py-3 text-sm font-semibold text-[var(--color-text-muted)] transition hover:text-[var(--color-text-primary)]">{t.volunteer}</Link>
