...
function PillarCard({
  ...
  return (
    ...
    >
      {/* Number */}
      <div
        className="mb-6 flex items-center gap-3 font-mono text-xs"
      ...
      {/* Headline */}
      <h3
        className="mb-4 font-serif leading-tight font-bold text-white"
        style={{
      ...
      <div
        className="absolute bottom-0 left-0 h-px w-0 rounded-full transition-all duration-500 group-hover:w-full"
      ...
      <div className="mx-auto max-w-7xl px-8 md:px-14 lg:px-20">
        ...
        <div ref={headerRef} className="mb-20 max-w-3xl">
          ...
          <motion.h2
            ...
            className="mb-6 font-serif leading-tight font-bold text-white"
            style={{
          ...
          >
            Schools teach memory. We teach survival — and from survival, we
            teach freedom. When young people know how to feed, hydrate, power,
            and house themselves, they stop working{" "}
            <em className="font-medium text-white not-italic">to survive</em>{" "}
            and start working{" "}
            <em className="font-medium text-white not-italic">to matter.</em>
          </motion.p>
        </div>
        ...
        <motion.div
          ...
          className="mt-16 flex flex-col items-start justify-between gap-8 pt-12 md:flex-row md:items-center"
        ...
        >
          ...
          >
            All programs are{" "}
            <strong className="font-medium text-white">free</strong> to accepted
            students. We fund them through earned revenue, grants, and donors
            like you. No gatekeeping. No debt. No strings.
          </p>
          <a
            href="#programs"
            className="inline-flex shrink-0 items-center gap-2 text-sm font-semibold tracking-widest uppercase transition-colors duration-300"
