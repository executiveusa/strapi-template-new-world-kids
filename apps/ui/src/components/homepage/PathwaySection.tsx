...
const copy = {
  en: {
    ...
    problemBody: "A young person can know what they care about and still have no clear way into useful experience, a mentor, or work.",
  ...
  es: {
    ...
    problemBody: "Un joven puede saber qué le importa y aun así no tener una ruta clara hacia experiencia útil, un mentor o trabajo.",
    ...
    <>
      ...
      <section id="programs" className="bg-[var(--color-ink)] py-20 text-white md:py-28">
        ...
        <div className="mx-auto mt-9 max-w-7xl px-5 sm:px-8 md:px-10">
          <Link href="/projects" locale={locale} className="inline-flex min-h-11 items-center text-sm font-bold text-white underline decoration-white/40 underline-offset-8 hover:decoration-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white">{t.pathwaysAction}</Link>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-9 lg:grid-cols-[0.8fr_1.2fr] lg:items-end lg:gap-16">
            ...
            <div className="border-t border-white/25 pt-6 lg:border-t-0 lg:pt-0">
              ...
              <Link href="/gallery" locale={locale} className="mt-7 inline-flex min-h-11 items-center rounded-full border border-white/35 px-5 text-sm font-bold text-white transition-colors hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white">{t.proofAction}</Link>
            </div>
          </div>
            ...
            <div className="mt-5 grid sm:grid-cols-2 lg:grid-cols-5">
              {t.outcomes.map((outcome, index) => (
                <div key={outcome} className="border-t border-white/20 py-5 sm:border-r sm:px-5 sm:last:border-r-0 lg:border-t-0">
                  ...
                  <p className="mt-2 text-base font-bold leading-6 text-white/88">{outcome}</p>
                </div>
              ))}
            </div>
          </div>
