...
const copy = {
  en: {
    ...
    title:
      "We help youth take the next step with something they already care about.",
    ...
    first:
      "In 2027, we're raising funds to launch the First 12 in Seattle: 12 paid positions with one-on-one mentorship and ongoing support, working inside a project aligned with the skills they're already interested in.",
  ...
  es: {
    eyebrow: "New World Kids · Seattle–Puerto Vallarta",
    title:
      "Ayudamos a jóvenes a dar el siguiente paso con algo que ya les importa.",
    ...
    first:
      "En 2027, estamos recaudando fondos para lanzar los Primeros 12 en Seattle: 12 puestos pagados con mentoría uno a uno y apoyo continuo, trabajando dentro de un proyecto alineado con las habilidades que ya les interesan.",
      ...
      <div className="relative min-h-[720px] w-full overflow-hidden md:min-h-[860px]">
        ...
        <div className="relative z-10 mx-auto flex min-h-[720px] max-w-[1440px] items-end px-6 pt-24 pb-12 md:min-h-[860px] md:items-center md:px-12 lg:px-16">
          <div className="max-w-[1040px] text-white">
            <p className="text-xs font-bold tracking-[0.22em] text-white uppercase sm:text-sm">
              {t.eyebrow}
            </p>
            ...
            <div className="mt-7 grid max-w-[980px] gap-5 md:grid-cols-[1.45fr_0.75fr] md:items-end">
              <p className="max-w-3xl text-base leading-7 text-white/92 sm:text-lg sm:leading-8 md:text-xl">
                {t.body}
              </p>
              <p className="border-l-2 border-[#2457FF] pl-4 text-sm leading-6 font-semibold text-white/90 sm:text-base">
                {t.first}
              </p>
            </div>
