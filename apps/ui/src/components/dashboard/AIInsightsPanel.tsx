...
export function AIInsightsPanel() {
  ...
  const generateMockInsights = (): AIInsight[] => [
    {
      ...
      description: 'The Smith Foundation grant matches your mission with 87% fit score. Deadline in 21 days.',
      confidence: 87,
      priority: 'high',
      actionable: true,
      action: {
    ...
    },
    {
      ...
      description: 'Grant application for "Tech Education Fund" due in 5 days. Current status: Drafting',
      confidence: 100,
      priority: 'urgent',
      actionable: true,
      action: {
    ...
    },
    {
      ...
      description: 'Grants mentioning "STEM education" and "underserved communities" have 92% success rate for your organization.',
      confidence: 92,
      priority: 'medium',
      actionable: false,
      timestamp: new Date(),
    },
    {
      ...
      description: 'Based on recent activities, consider adding a timeline event about your summer program impact.',
      confidence: 78,
      priority: 'low',
      actionable: true,
      action: {
  ...
  const generateMockAgents = (): AgentActivity[] => [
    {
    ...
    <div className="ai-insights-panel">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Real-time recommendations and agent status from the AI orchestration system
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="insights">
                ...
                <AnimatePresence>
                  {insights.map((insight, index) => (
                    <motion.div
                      ...
                      className={`insight-card border-l-4 rounded-lg p-4 ${getPriorityColor(insight.priority)}`}
                    >
            ...
            <TabsContent value="agents" className="space-y-4">
              {agents.map((agent, index) => (
                <motion.div
                  ...
                  transition={{ delay: index * 0.1 }}
                  className="agent-card border rounded-lg p-4"
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">{agent.lastActivity}</p>
                      </div>
                    </div>
            ...
            <TabsContent value="analytics">
              <div className="analytics-grid grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card>
                  <CardHeader>
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-gray-500 mt-1">Across all insights</p>
                  </CardContent>
                </Card>
