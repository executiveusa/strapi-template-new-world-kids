...
export const timelineEntries: TimelineEntry[] = [
  {
    ...
    tagline: "Before a school, the site had to become livable.",
    body: "Volunteers from Seattle's Culture Shock program arrived in Paso de Guayabo and rented 1.5 acres that could barely support life. Soil restoration started first because food, water, energy, and shelter only become teachable when the land itself starts recovering.",
    highlights: [
      "1.5 acres secured",
      "Soil restoration begun",
      "Food-first land recovery plan mapped",
  ...
  },
  {
    ...
    tagline: "The neighborhood showed up. We listened and kept building.",
    body: "The founder lived full-time in the community. Local children started arriving to plant, learn, and spend time on the site. Trust and proof of concept grew together around practical lessons tied to food, water, language, and belonging.",
    highlights: [
      ...
      "First recurring field-learning rhythms established",
    ],
    photo: "",
  ...
  },
  {
    ...
    tagline: "The living classroom is real. Now the systems have to catch up.",
    body: "The site crossed 200 plant varieties. Syntropic agriculture is working. Hermes is being brought online to support grants, reporting, and operations while fundraising pushes the next build phase forward across food, water, energy, and shelter.",
    highlights: [
      "200+ plant varieties growing",
      "Water, energy, and shelter plans now need donor backing",
  ...
  },
  {
    ...
    tagline: "Five students. Four pillars. One visible standard of proof.",
    body: "The learning center opens to its first student cohort, blending local youth participation with Culture Shock students from Seattle. Hermes supports the reporting and operational layer while the curriculum stays grounded in food, water, energy, and shelter.",
    highlights: [
      "Learning center operational",
      "Four-pillar curriculum live on site",
  ...
  },
  {
    ...
    tagline: "A model that can travel because it stays practical.",
    body: "Graduates bring skills home. The food forest feeds more of the school. Revenue diversifies through seeds, plants, oils, tours, and creative work tied back to the mission and the four pillars.",
    highlights: [
  ...
  },
  {
    ...
    tagline: "A durable model, not a one-off inspiration cycle.",
