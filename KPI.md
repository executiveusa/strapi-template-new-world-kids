...
- The trust center now has seeded public documents in `apps/ui/public/trust/`.
- The journal now has seeded English and Spanish pillar content.
- Hermes is now a separate service and should become the health target for backend uptime.
- This file is still a prelaunch baseline and should be refreshed once the primary donation rail and analytics are live.
